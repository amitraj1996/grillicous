jQuery(document).ready(function($){
	...
	if($('body').hasClass('pace-running')){
		...
		interLoading = setInterval(function(){
			...
			$('#percent h2').html(progressTotalFloor + '%');
			if(progressTotalFloorOld != progressTotalFloor){
				inc ++;
				if(inc==4) inc = 0;
				//$('#percent h2').css('color', colorArr[inc]);
				TweenMax.to('#percent h2', 0.5,{css:{color:colorArr[inc]}})
...
/*			$('.section4').mouseover(function(e){
		...
		var section9TweenEquipe4 = new TimelineMax()
		.fromTo(".section9 .equipe4", .7, {opacity:0, y:100}, {opacity:1, y:0, ease:Quad.easeOut})
		sceneSection9Equipe3 = new ScrollMagic.Scene({
			triggerElement: ".section9 .equipe4",
			triggerHook: "onEnter",
		})
		.setTween(section9TweenEquipe4)
		.addTo(controller);

		var section9TweenEquipe5 = new TimelineMax()
		.fromTo(".section9 .equipe5", .7, {opacity:0, y:100}, {opacity:1, y:0, ease:Quad.easeOut})
		sceneSection9Equipe5 = new ScrollMagic.Scene({
			triggerElement: ".section9 .equipe5",
			triggerHook: "onEnter",
		})
		.setTween(section9TweenEquipe5)
		.addTo(controller);


		var section9TweenEquipe6 = new TimelineMax()
		.fromTo(".section9 .equipe6", .7, {opacity:0, y:100}, {opacity:1, y:0, ease:Quad.easeOut})
		sceneSection9Equipe6 = new ScrollMagic.Scene({
			triggerElement: ".section9 .equipe6",
			triggerHook: "onEnter",
		})
		.setTween(section9TweenEquipe6)
		.addTo(controller);



		var section9TweenEquipe7 = new TimelineMax()
		.fromTo(".section9 .equipe7", .7, {opacity:0, y:100}, {opacity:1, y:0, ease:Quad.easeOut})
		sceneSection9Equipe7 = new ScrollMagic.Scene({
			triggerElement: ".section9 .equipe7",
			triggerHook: "onEnter",
		})
		.setTween(section9TweenEquipe7)
		.addTo(controller);


		var section9TweenEquipe8 = new TimelineMax()
		.fromTo(".section9 .equipe8", .7, {opacity:0, y:100}, {opacity:1, y:0, ease:Quad.easeOut})
		sceneSection9Equipe8 = new ScrollMagic.Scene({
			triggerElement: ".section9 .equipe8",
			triggerHook: "onEnter",
		})
		.setTween(section9TweenEquipe8)
		.addTo(controller);


		
		var section9TweenEquipe9 = new TimelineMax()
		.fromTo(".section9 .equipe9", .7, {opacity:0, y:100}, {opacity:1, y:0, ease:Quad.easeOut})
		sceneSection9Equipe9 = new ScrollMagic.Scene({
			triggerElement: ".section9 .equipe9",
			triggerHook: "onEnter",
		})
		.setTween(section9TweenEquipe9)
		.addTo(controller);
